...
%subclass DD_Custom_SBBulletinObserverViewController :  SBBulletinObserverViewController
...
{
    // don't add SBBulletinViewController (UITableViewController)
}

- (void)_insertContentUnavailableView
{
    // don't add _UIContentUnavailableView on 7.1.x and up
}
