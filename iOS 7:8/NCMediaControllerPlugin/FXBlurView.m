...
- (UIImage *)blurredImageWithRadius:(CGFloat)radius iterations:(NSUInteger)iterations tintColor:(UIColor *)tintColor saturationDelta:(CGFloat)saturationDelta
{
    ...
    {
        CGContextSetFillColorWithColor(ctx, [tintColor colorWithAlphaComponent:kTintColorAlpha].CGColor);
...
{
    return [snapshot blurredImageWithRadius:self.blurRadius iterations:self.iterations tintColor:self.tintColor saturationDelta:self.saturationDeltaFactor];
}
